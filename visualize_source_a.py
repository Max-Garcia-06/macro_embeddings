...
EMBEDDINGS_PARQUET_PATH: Path = Path(__file__).resolve().parent / "source_a_embeddings.parquet"
CENTROIDS_CACHE_PATH: Path = Path(__file__).resolve().parent / "county_centroids.parquet"
OUTPUT_HTML_PATH: Path = Path(__file__).resolve().parent / "source_a_map.html"
