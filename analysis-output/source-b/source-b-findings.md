...
### 3.3 Suppression: 30.0% of cells, shipped as honest nulls (full derivation in `source_b_plan.md` Phase 1b)
...
- Full phased research/design history (access mechanism, suppression-handling comparison, own_code scope decision): `source_b_plan.md`
